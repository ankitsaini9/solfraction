...
import { programID,mint1,token_mint,user_account, PDA_state_account,metadata_program_id  } from "./ids";
...
export const reclaim_nft_by_owner = async(owner_account) => {
  ...
  const initStakeIx = new TransactionInstruction({
    ...
    keys: [
      ...
      { pubkey: owner_account, isSigner: true, isWritable: true },
